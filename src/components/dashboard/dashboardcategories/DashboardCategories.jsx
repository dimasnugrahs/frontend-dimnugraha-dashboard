...
export default function DashboardCategories() {
  ...
  const isIndexRoute = location.pathname === "/categories";

  // Jika kita berada di Sub-URL (/categories/create atau /categories/update)
  if (!isIndexRoute) {
    // RENDER HANYA SUB-KOMPONEN (CreateCategories atau UpdateCategories)
    return <Outlet />;
  }
