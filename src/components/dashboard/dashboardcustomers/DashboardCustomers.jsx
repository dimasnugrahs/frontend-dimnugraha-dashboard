...
export default function DashboardCustomers() {
  ...
  const isIndexRoute = location.pathname === "/customers";

  // Jika kita berada di Sub-URL (/customers/create atau /customers/update)
  if (!isIndexRoute) {
    // RENDER HANYA SUB-KOMPONEN (CreateCustomers atau UpdateCustomers)
    return <Outlet />;
  }
  return (
    <>
