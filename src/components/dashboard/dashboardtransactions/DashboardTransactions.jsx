...
export default function DashboardTransactions() {
  ...
  const isIndexRoute = location.pathname === "/transactions";

  // Jika kita berada di Sub-URL (/transactions/create atau /transactions/update)
  if (!isIndexRoute) {
    // RENDER HANYA SUB-KOMPONEN (CreateTransactions atau UpdateTransactions)
    return <Outlet />;
  }
  return (
    <>
